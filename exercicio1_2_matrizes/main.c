...
int main(void){
    ...
    printf("1.2) Matriz identidade com ponteiros de ponteiros\n\n");

    printf("Caso identidade tamanho 2\n\n");

    int** mat_id2 = cria_matriz(2, 1);
    imprime_matriz(mat_id2, 2);
    if (matriz_identidade(mat_id2, 2) == 1) printf("PASSOU! É identidade!\n");
    else printf("FALHOU! Não é identidade!\n");
    ...
    if (matriz_identidade(mat_id3, 3) == 1) printf("PASSOU! É identidade!\n");
    else printf("FALHOU! Não é identidade!\n");
    ...
    if (matriz_identidade(mat_id4, 4) == 1) printf("PASSOU! É identidade!\n");
    else printf("FALHOU! Não é identidade!\n");
    ...
    if (matriz_identidade(mat_n_id2, 2) == 0) printf("PASSOU! Não é identidade!\n");
    else printf("FALHOU! É identidade!\n");
    ...
    if (matriz_identidade(mat_n_id3, 3) == 0) printf("PASSOU! Não é identidade!\n");
    else printf("FALHOU! É identidade!\n");
    ...
    if (matriz_identidade(mat_n_id4, 4) == 0) printf("PASSOU! Não é identidade!\n");
    else printf("FALHOU! É identidade!\n");
